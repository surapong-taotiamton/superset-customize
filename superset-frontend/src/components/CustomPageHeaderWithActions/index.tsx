...
export type CustomPageHeaderWithActionsProps = {
...
export const CustomPageHeaderWithActions = ({
  editableTitleProps,
  showTitlePanelItems,
  ...
  tooltipProps,
}: CustomPageHeaderWithActionsProps) => {

  const dispatch = useDispatch();
  const dataFromState: any = useSelector((state: any) => state.setFilterReducer); // ดึง state ส่วน user

  const toggleFilter = function() {
    dispatch( setFilter(!dataFromState) )
  }


  console.log("DEBUG dataFromState ", dataFromState);
